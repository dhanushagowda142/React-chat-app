  ...
  return (
    <section id='hero'>
        <div className="container">
            <div className="row">
                <div className="col-md-6 offset-md-6 col-lg-6 offset-lg-3 col-sm-12">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <form autoComplete='off' onSubmit={submitHandler}>
                               ...
                               <div className="form-group mt-2">
                                  ...
                                  <input type="file" name="file" id="file" onChange={readFile} className='form-control' required />
                               </div>

                               <div className="form-group mt-2">
                                  <input type="submit" value="Register" disabled={loading} className='btn btn-primary' required />
